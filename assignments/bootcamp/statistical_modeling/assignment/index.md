...
* information about the number and parental origin of each de novo mutation detected in an offspring individual (i.e. "proband"), stored in `aau1043_dnm.tsv`
* ages of the parents of each proband, stored in `aau1043_parental_age.tsv`
